    ...
    <table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
        <tr>
            <td bgcolor="#ffffff" class="fs12" height="50">
                - URL：<!--{$tpl_site_url}--><br/>
                - Shop：<!--{$tpl_shop_name}--><br/>
                - EC-CUBE：<!--{$tpl_cube_ver}--><br/>
                - PHP：<!--{$tpl_php_ver}--><br/>
                - DB：<!--{$tpl_db_ver}--><br/>
            </td>
        </tr>
...
<tr><td align="left" class="fs12"><input type="radio" id="ok" name="send_info" checked value=true><label for="ok">Yes(Recommendation)</label>　<input type="radio" id="ng" name="send_info" value=false><label for="ng">No</label></td></tr>
</table>
...
<table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
    ...
    <tr>
        <td align="center">
        <a href="#" onmouseover="chgImg('../<!--{$default_dir}-->/img/install/back_on.jpg','back')" onmouseout="chgImg('../<!--{$default_dir}-->/img/install/back.jpg','back')" onclick="document.form1['mode'].value='return_step3';document.form1.submit();return false;" /><img  width="105" src="../<!--{$default_dir}-->/img/install/back.jpg"  height="24" alt="Return" border="0" name="back"></a>
