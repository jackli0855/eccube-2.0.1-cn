...
<title><!--{$arrSiteInfo.shop_name}-->/调查（结束页面）</title>
</head>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		...
		<table width="710" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<td height="30"width="695" class="red"><strong><span class="fs18n">调查标题</span></strong></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<form name="form1" id="form1" method="post" action="">
			<tr>
				<td bgcolor="#ffffff" height="250" align="center" class="fs12">已完成调查的发送。<br>
				感谢您的大力支持。<br><br><br>

				<input type="submit" name="subm1" value="关闭" onClick="window.close()"></td>
			</tr>
		</form>
		</table>
		</td>
