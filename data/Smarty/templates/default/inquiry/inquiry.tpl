...
<!--{section name=question loop=$QUESTION.question}-->
	<!--{if $QUESTION.question[question].kind }-->
		...
		<tr>
			...
			<!--{if $arrErr.option[$smarty.section.question.index]}--><br><span class="red">请输入问题<!--{$smarty.section.question.iteration}--></sapn><!--{/if}-->
			</td>
		</tr>
		...
		<tr>
			...
			<table width="540" border="0" cellspacing="0" cellpadding="3" summary=" ">
				...
				<!--{if $arrErr.option[$smarty.section.question.index]}--><tr><td class="fs12n"><span class="red">请输入问题<!--{$smarty.section.question.iteration}--></sapn></td></tr><!--{/if}-->
				</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table width="540" border="0" cellspacing="0" cellpadding="3" summary=" ">
				...
				<!--{/section}-->
				<!--{if $arrErr.option[$smarty.section.question.index]}--><tr><td class="fs12n"><span class="red">请输入问题<!--{$smarty.section.question.iteration}-->  </sapn></tr><!--{/if}-->
			</table>
			</td>
		</tr>
		<!--{/if}-->
