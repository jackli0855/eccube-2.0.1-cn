...
<div id="undercolumn">
  ...
  <div id="detailarea">
    ...
    <!--★画像★-->
      ...
      <!--★拡大する★-->
        <a href="javascript:void(win01('./detail_image.php?product_id=<!--{$arrProduct.product_id}-->&amp;image=main_large_image<!--{if $smarty.get.admin == 'on'}-->&amp;admin=on<!--{/if}-->','detail_image','<!--{$arrFile.main_large_image.width+60}-->', '<!--{$arrFile.main_large_image.height+80}-->'))" onmouseover="chgImg('<!--{$TPL_DIR}-->img/products/b_expansion_on.gif','expansion01');" onMouseOut="chgImg('<!--{$TPL_DIR}-->img/products/b_expansion.gif','expansion01');">
          <img src="<!--{$TPL_DIR}-->img/products/b_expansion.gif" width="85" height="13" alt="放大图片" name="expansion01" id="expansion01" />
       </a>
      </p>
      <!--{else}-->
      <img src="<!--{$arrFile[$key].filepath}-->" width="<!--{$smarty.const.NORMAL_IMAGE_WIDTH}-->" height="<!--{$smarty.const.NORMAL_IMAGE_HEIGHT}-->" alt="<!--{$arrProduct.name|escape}-->" class="picture" />
    ...
    <div id="detailrightblock">
      ...
      <!--★価格★-->
      <div><!--{$smarty.const.SALE_PRICE_TITLE}--><span class="mini">(含税)</span>：
        <span class="price">
      ...
      <form name="form1" id="form1" method="post" action="<!--{$smarty.server.REQUEST_URI|escape}-->">
        ...
        <dl>
          ...
          <dd>
            ...
            <br /><span class="attention">※ 请输入<!--{$tpl_class_name1}-->。</span>
          <!--{/if}-->
          </dd>
        </dl>
        <!--{/if}-->
        ...
        <dl>
          ...
          <dd>
            ...
            <br /><span class="attention">※ 请输入<!--{$tpl_class_name2}-->。</span>
            <!--{/if}-->
          </dd>
        </dl>
          <!--{/if}-->
        ...
        <p class="btn">
          ...
          <a href="javascript:void(document.form1.submit())" onmouseover="chgImg('<!--{$TPL_DIR}-->img/products/b_cartin_on.gif','cart');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/products/b_cartin.gif','cart');">
            <img src="<!--{$TPL_DIR}-->img/products/b_cartin.gif" width="115" height="25" alt="放入购物车" name="cart" id="cart" />
          </a>
        </p>
        <!--{else}-->
        <div class="attention">非常抱歉，现在断货了。</div>
        <!--{/if}-->
      </form>
      ...
      <!--{if $arrFile[$lkey].filepath != ""}-->
        ...
        <p>
          <a href="<!--{$smarty.server.PHP_SELF|escape}-->"
            ...
            <img src="<!--{$TPL_DIR}-->img/products/b_expansion.gif" width="85" height="13" alt="放大图片" />
          </a>
        </p>
      <!--{/if}-->
      </div>
  ...
  <div id="customervoicearea">
    <h2><img src="<!--{$TPL_DIR}-->img/products/title_voice.jpg" width="580" height="30" alt="对此商品的评论" /></h2>
    ...
    <!--★新規コメントを書き込む★-->
      <a href="./review.php"
        ...
        <img src="<!--{$TPL_DIR}-->img/products/b_comment.gif" width="150" height="22" alt="写新的评论" name="review" id="review" />
      </a>
    <!--{/if}-->
    ...
    <!--{section name=cnt loop=$arrReview}-->
      <li>
        <p class="voicedate"><!--{$arrReview[cnt].create_date|sfDispDBDate:false}-->　投稿人：<!--{if $arrReview[cnt].reviewer_url}--><a href="<!--{$arrReview[cnt].reviewer_url}-->" target="_blank"><!--{$arrReview[cnt].reviewer_name|escape}--></a><!--{else}--><!--{$arrReview[cnt].reviewer_name|escape}--><!--{/if}-->　推荐等级：<span class="price"><!--{assign var=level value=$arrReview[cnt].recommend_level}--><!--{$arrRECOMMEND[$level]|escape}--></span></p>
  ...
  <div id="trackbackarea">
    <h2><img src="<!--{$TPL_DIR}-->img/products/title_tb.jpg" width="580" height="30" alt="跟踪此商品" /></h2>
    <h3>跟踪此商品的URL</h3>
  ...
  <div id="whoboughtarea">
    <h2><img src="<!--{$TPL_DIR}-->img/products/title_recommend.jpg" width="580" height="30" alt="推荐商品" /></h2>
    ...
    <!--{section name=cnt loop=$arrRecommend}-->
      ...
      <!--{/if}-->
        ...
        <p>价格<span class="mini">(含税)</span>：<span class="price">
