...
<div id="under02column">
  <div id="under02column_error">
    ...
    <!--{else}-->
      <a href="javascript:history.back()" onmouseOver="chgImg('<!--{$TPL_DIR}-->img/common/b_back_on.gif','b_back');" onmouseOut="chgImg('<!--{$TPL_DIR}-->img/common/b_back.gif','b_back');"><img src="<!--{$TPL_DIR}-->img/common/b_back.gif" width="150" height="30" alt="返回" name="b_back" id="b_back" /></a>
    <!--{/if}-->
    </div>
  </div>
</div>
