							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->模块功能一览</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="4" summary=" ">
									...
									<tr bgcolor="#ffffff" class="fs12">
										...
										<td ><!--{$arrUpdate[cnt].module_explain}-->(对应于<!--{$arrUpdate[cnt].eccube_version}-->以后的版本)</td>
										...
										<!--{if $arrUpdate[cnt].now_version == "" || $arrUpdate[cnt].now_version < $arrUpdate[cnt].latest_version}-->
											...
											<span class="icon_edit"><a href="#" onclick="fnModeSubmit('install','module_id','<!--{$arrUpdate[cnt].module_id}-->');">应用</a></span>
											<!--{else}-->
											-
											<!--{/if}-->
										<!--{else}-->
											<span class="icon_delete"><a href="#" onclick="fnModeSubmit('uninstall','module_id','<!--{$arrUpdate[cnt].module_id}-->');">删除</a></span>
										<!--{/if}-->									
										</td>
										<td align="center">
										<!--{if $arrUpdate[cnt].now_version != ""}-->
											<span class="icon_confirm"><a href="#" onclick="win01('<!--{$smarty.const.URL_DIR}-->load_module.php?module_id=<!--{$arrUpdate[cnt].module_id}-->','module<!--{$arrUpdate[cnt].module_id}-->','<!--{$arrUpdate[cnt].module_x}-->','<!--{$arrUpdate[cnt].module_y}-->'); return false;">运行</a></span>
										<!--{else}-->
											-
										<!--{/if}-->
										</td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><input type="submit" name="subm" value="取得最新的更新"/></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
