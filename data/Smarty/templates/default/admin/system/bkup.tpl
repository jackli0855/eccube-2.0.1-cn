							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->制作备份</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr align="center" class="fs12n">
										<td bgcolor="#f2f1ec" width="130">备份名<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="548" align=left>
											<span class="red12"><!--{$arrErr.bkup_name}--></span>
											<input type="text" name="bkup_name" value="<!--{$arrForm.bkup_name|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="60" class="box60" style="<!--{if $arrErr.bkup_name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}--> ime-mode: disabled;" /><span class="red"> （最多<!--{$smarty.const.STEXT_LEN}-->字）</span>
										</td>
									</tr>
									<tr align="center" class="fs12n">
										<td bgcolor="#f2f1ec" width="130">备份备注</td>
										<td bgcolor="#ffffff" width="548" align=left>
											...
											<span class="red"> （最多<!--{$smarty.const.MTEXT_LEN}-->字）</span>
										</td>
									</tr>
								</table>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><input type="button" name="cre_bkup" value="制作备份数据" onClick="document.body.style.cursor = 'wait'; form1.mode.value='bkup'; submit();" /></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->备份一览</span></td>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
									</tr>
									<tr>
										<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr bgcolor="#f2f1ec" align="center" class="fs12n">
										...
										<td width="338">备份备注</td>
										<td width="170">制作日期</td>
										<td width="50">恢复</td>
										<td width="90">下载</td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr bgcolor="#ffffff" class="fs12">
										<td>
											▼実行結果<br>
											<!--{if $restore_err == false}--><input type="button" name="restore_config" value="忽略表结构进行恢复" onClick="document.body.style.cursor = 'wait'; form1.mode.value='restore_config'; form1.list_name.value='<!--{$restore_name}-->'; submit();" /><br><!--{/if}-->
											<!--{$restore_msg}-->
										</td>
									</tr>								
								</table>
