				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">月份合计</td>
								<td bgcolor="#ffffff" width="607" colspan="3">
									...
									</select>月份（<!--{if $smarty.const.CLOSE_DAY == 31}-->末<!--{else}--><!--{$smarty.const.CLOSE_DAY}--><!--{/if}-->日截止）
									　<input type="submit" name="subm" value="按月合计" />
								</td>
							</tr>
							</form>
							...
							<input type="hidden" name="type" value="<!--{$smarty.post.type}-->">
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">期间合计</td>
								<td bgcolor="#ffffff" width="607" colspan="3">
									...
									　<input type="submit" name="subm" value="按期间合计" />
								</td>
							</tr>
							</form>
						...
						<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr><td align="center">
								...
								<table width="740" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td align = center>
										<input type="button" name="subm" value="以CSV格式下载检索结果" onclick="fnModeSubmit('csv','','');" />
										<!--{* PDF機能は次期開発で追加予定
										 <input type="button" name="subm" value="以PDF格式下载检索结果" onclick="fnModeSubmit('pdf','','');" />
										*}-->
										</td>
									</tr>
								</table>
						...
						<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr><td align="center">	
								...
								<table width="740" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr class="fs12"><td align="center" height="200">没有符合条件的记录。</td></tr>
								</table>
								</td>
							</tr>
						</table>
