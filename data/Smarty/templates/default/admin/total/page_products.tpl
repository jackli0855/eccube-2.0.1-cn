...
<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
	<tr bgcolor="#636469" align="center" class="fs12n">
		<td width="40"><span class="white">顺序</span></td>
		<td width="80"><span class="white">商品编号</span></td>
		<td width="300"><span class="white">商品名称</span></td>				
		<td width="80"><span class="white">购买件数</span></td>
		<td width="80"><span class="white">点数</span></td>
		<td width="80"><span class="white">单价</span></td>
		<td width="80"><span class="white">金额</span></td>
	</tr>
	...
	<tr bgcolor="<!--{$color}-->" class="fs12">
		...
		<td align="right"><!--{*単価*}--><!--{$arrResults[cnt].price|number_format}-->元</td>
		<td align="right"><!--{*金額*}--><!--{$arrResults[cnt].total|number_format}-->元</td>
	</tr>
	<!--{/section}-->
