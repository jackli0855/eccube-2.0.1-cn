								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<!--{section name=cnt loop=$arrDelivList}-->
										<tr bgcolor="#ffffff" class="fs12n">
											...
											<td align="center"><a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnChangeAction('./delivery_input.php'); fnModeSubmit('pre_edit', 'deliv_id', <!--{$arrDelivList[cnt].deliv_id}-->); return false;">修改</a></td>
											
											<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('delete', 'deliv_id', <!--{$arrDelivList[cnt].deliv_id}-->); return false;">删除</a></td>
											<td align="center">
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><input type="button" name="subm2" value="添加送货商<!--{if $smarty.const.INPUT_DELIV_FEE}-->・运费<!--{/if}-->" onclick="fnChangeAction('./delivery_input.php'); fnModeSubmit('pre_edit','','');" /></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
