							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->站点管理设置</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr align="center" bgcolor="#f2f1ec" class="fs12n">
										<td width="396">管理标题/管理内容</td>
										<td width="128">选择项目</td>
										<td width="44">编辑</td>
									</tr>
									...
									<tr bgcolor="#ffffff" class="fs12n">
										...
										<td align="center">
											<input type="submit" value="编辑" name="subm">
										</td>
										</form>
									</tr>
									<!--{/section}-->
