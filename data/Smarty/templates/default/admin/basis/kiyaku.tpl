					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->会员规则注册</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr>
								<td bgcolor="#f2f1ec" width="160" class="fs12n">规则标题<span class="red"> *</span></td>
								...
								<span class="red"> （最多<!--{$smarty.const.SMTEXT_LEN}-->字）</span>
								</td>
							</tr>
							<tr>
								<td bgcolor="#f2f1ec" width="160" class="fs12n">规则内容<span class="red"> *</span></td>
								<td bgcolor="#ffffff" width="557" class="fs10n">
								...
								<span class="red"> （最多<!--{$smarty.const.MLTEXT_LEN}-->字）</span>
								</td>
							</tr>
						</table>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr bgcolor="<!--{if $tpl_class_id != $arrKiyaku[cnt].kiyaku_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->" class="fs12">
								...
								<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('pre_edit', 'kiyaku_id', <!--{$arrKiyaku[cnt].kiyaku_id}-->); return false;">编辑</a>
								<!--{else}-->
								正在编辑
								<!--{/if}-->
								</td>
								...
								-
								<!--{else}-->
								<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('delete', 'kiyaku_id', <!--{$arrKiyaku[cnt].kiyaku_id}-->); return false;">删除</a>
								<!--{/if}-->
								</td>
								<td align="center">
								...
								<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('down', 'kiyaku_id', <!--{$arrKiyaku[cnt].kiyaku_id}-->); return false;" />下一步</a>
								<!--{/if}-->
								</td>
							</tr>
							<!--{/section}-->
