							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->数据管理</span></td>
								...
								<input type="hidden" name="master_data_name" value="<!--{$masterDataName}-->">
								  <tr class="fs12n">
								    <td bgcolor="#f2f1ec" align="center" colspan="2"><strong>数据编辑</strong></td>
								  </tr>
								  <tr class="fs12n">
								    <td bgcolor="#ffffff" align="left" colspan="2">
								      <ul class="red">
								        <li>可以进行数据设置。</li>
								        <li>不能注册重复的ID。</li>
								        <li>如果注册空的ID，其数据将被删除。</li>
								        <li>请注意，有可能因为所设置的值不当而导致站点无法运转。</li>
								      </ul>
								    </td>
								  </tr>
								  ...
								  <tr class="fs12n">
								    ...
								    <td bgcolor="#ffffff" align="left">
								    值：<input type="text" name="name[]" value="<!--{$val|escape}-->" style="" size="60"
								            class="box60" />
								    </td>
								  </tr>
								  <!--{/foreach}-->
								  <tr class="fs12n">
								    <td bgcolor="#f2f1ec" align="center" colspan="2">添加的数据</td>
								  </tr>
								  <tr class="fs12n">
								    <td bgcolor="#ffffff" align="left">
								    ...
								    <td bgcolor="#ffffff" align="left">
								    值：<input type="text" name="name[]" style="" size="60"
								            class="box60" />
								    </td>
								  </tr>
								</form>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													<input onClick="return document.form2.submit()" type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm" >
												</td>
											</tr>
										</table>
