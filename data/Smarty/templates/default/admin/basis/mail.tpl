...
function checkFlagAndSubmit(){
	if ( flag == 1 ){
		if( confirm('内容已经修改过。如果继续的话，所修改的内容将被舍弃。\n继续吗？' )){
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->邮件设置</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">模板<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">邮件标题<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12">邮件头</td>
										...
										<span class="red"> （最多<!--{$smarty.const.LTEXT_LEN}-->字）
										</span>
						
										<div align="right">
											<input type="button" width="110" height="30" value="字数计数器" onclick="fnCharCount('form1','header','cnt_header');" border="0" name="next" id="next" />
											<br>现在为止输入了
									...
									<tr class="fs12n">
										<td bgcolor="#ffffff" colspan="2" align="center" height="40">动态数据插入部分</td>
									</tr>
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12">邮件的页脚</td>
										<td bgcolor="#ffffff" width="557" class="fs10">
										...
										<span class="red"> （最多<!--{$smarty.const.LTEXT_LEN}-->字）</span>
										<div align="right">
											<input type="button" width="110" height="30" value="字数计数器" onclick="fnCharCount('form1','footer','cnt_footer');" border="0" name="next" id="next" />
											<br>现在为止输入了
