							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->积分设置</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="170">积分支付率<span class="red"> *</span></td>
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="170">会员注册时赠送点数<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557">
