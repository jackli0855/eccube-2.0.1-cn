							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->送货商注册</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td width="100" bgcolor="#f2f1ec">送货商名<span class="red"> *</span></td>
									...
									<tr class="fs12n">
										<td width="100" bgcolor="#f2f1ec">票据No.URL</td>
										<td width="617" bgcolor="#ffffff" colspan="3">
									...
									<!--{if $type == 0}-->
										...
										<!--{/if}-->
										<tr class="fs12n">
										<td width="100" bgcolor="#f2f1ec">送货时间<!--{$keyno}--></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->送货费用注册</span></td>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
									</tr>
									<tr>
										<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#ffffff" colspan="4">※设定为全国统一运费 <input type="text" name="fee_all" size="10" class="box10" /> 元　<input type="button" name="renew" value="刷新" onclick="fnSetDelivFee(<!--{$smarty.const.DELIVFEE_MAX}-->);" /></td>
									</tr>
									...
									<!--{if $type == 0}-->
										...
										<!--{/if}-->
										<td width="247" bgcolor="#ffffff" colspan="<!--{$colspan}-->">
										<input type="text" name="<!--{$arrForm[$key].keyname}-->" value="<!--{$arrForm[$key].value|escape}-->" maxlength="<!--{$arrForm[$key].length}-->" size="20" class="box20" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" /> 元</td>
									<!--{else}-->
										<td width="100" bgcolor="#f2f1ec"><!--{$arrPref[$keyno]}--></td>
										<td width="248" bgcolor="#ffffff"><input type="text" name="<!--{$arrForm[$key].keyname}-->" value="<!--{$arrForm[$key].value|escape}-->" maxlength="<!--{$arrForm[$key].length}-->" size="20" class="box20" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" /> 元</td>
										</tr>
									<!--{/if}-->
									<!--{/section}-->
								</table>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													<a href="./delivery.php" onmouseover="chgImg('<!--{$TPL_DIR}-->img/contents/btn_back_on.jpg','back');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/contents/btn_back.jpg','back');"><img src="<!--{$TPL_DIR}-->img/contents/btn_back.jpg" width="123" height="24" alt="返回前面的页面" border="0" name="back"></a>
