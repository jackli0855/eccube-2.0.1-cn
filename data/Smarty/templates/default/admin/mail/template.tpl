							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->模板</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr bgcolor="#ffffff" class="fs12n">
										...
										<td width="40" align="center"><!--{if $list_data[data].mail_method eq 3}--><a href="./htmlmail.php?mode=edit&template_id=<!--{$list_data[data].template_id}-->"><!--{else}--><a href="./template_input.php?mode=edit&template_id=<!--{$list_data[data].template_id}-->"><!--{/if}-->编辑</a></td>
										<td width="40" align="center"><a href="" onclick="fnDelete('<!--{$smarty.server.PHP_SELF|escape}-->?mode=delete&id=<!--{$list_data[data].template_id}-->'); return false;">删除</a></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													<input type="button" name="subm" onclick="location.href='./template_input.php'" value="新建" />　
													<!-- ＨＴＭＬ作成ウィザードは保留 （次期開発）
													<input type="button" name="subm" onclick="location.href='./htmlmail.php'" value="HTML模板制作向导" />
													-->
												</td>
											</tr>
										</table>
