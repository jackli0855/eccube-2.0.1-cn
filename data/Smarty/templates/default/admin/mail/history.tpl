							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->送信履历</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" ">
									<tr bgcolor="#f2f1ec" align="center" class="fs12n">
										<td width="110">送信开始时间</td>
										<td width="350" rowspan="2">Subject</td>
										<td width="40" rowspan="2">预览</td>
										<td width="40" rowspan="2">送信条件</td>
										<td width="86">预定送信条数</td>
										<td width="37" rowspan="2">删除</td>
									</tr>
									<tr bgcolor="#f2f1ec" align="center" class="fs12n">
										<td>送信结束时间</td>
										<td>送信条数</td>
									...
									<tr bgcolor="#ffffff" class="fs12n">
										...
										<td align="center" rowspan="2"><a href="./preview.php?send_id=<!--{$arrDataList[cnt].send_id|escape}-->" target="_blank">确认</a></td>
										<td align="center" rowspan="2"><a href="#" onclick="win03('./index.php?mode=query&send_id=<!--{$arrDataList[cnt].send_id|escape}-->','query','720','420'); return false;">确认</a></td>
										<td align="center"><!--{$arrDataList[cnt].send_count|escape}--></td>
										<td align="center" rowspan="2"><a href="<!--{$smarty.server.PHP_SELF|escape}-->?mode=delete&send_id=<!--{$arrDataList[cnt].send_id|escape}-->" onclick="return window.confirm('可以删除送信履历吗？');">删除</a></td>
									</tr>
									<tr bgcolor="#ffffff" class="fs12n">
