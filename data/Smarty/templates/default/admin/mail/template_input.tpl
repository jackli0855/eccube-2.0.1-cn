							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->送信内容设置：<!--{$title}--></span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec">邮件形式<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" colspan="2" class="fs12n">正文<span class="red"> *</span>（插入姓名时请输入 {name} ）</td>
									</tr>
									<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td width="30%"></td>
												<td width="40%" align = "center" valign="upper"><input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm"></td>
												<td width="30%" align = "right" valign="upper"><input type="button" width="110" height="30" value="文字数计数器" onclick="fnCharCount('form1','body','cnt_footer');" border="0" name="next" id="next" />
												<br><span class="fs10n">目前已输入<input type="text" name="cnt_footer" size="4" class="box4" readonly = true style="text-align:right">字。</span></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
