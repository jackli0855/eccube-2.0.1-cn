					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->送信地检索条件设置</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr class="fs12n">
								...
								<td bgcolor="#ffffff" width="194">
									...
									<select name="pref">
										<option value="" selected="selected"  style="<!--{$arrErr.pref|sfGetErrorColor}-->">选择省市自治区</option>
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">送信形式</td>
								<td bgcolor="#ffffff" width="194">
								...
								<td bgcolor="#ffffff" width="195">
									...
									<input type="text" name="buy_times_from" maxlength="<!--{$smarty.const.INT_LEN}-->" value="<!--{$list_data.buy_times_from|escape}-->" size="6" class="box6" style="<!--{$arrErr.buy_times_from|sfGetErrorColor}-->" /> 次 ～ 
									<input type="text" name="buy_times_to" maxlength="<!--{$smarty.const.INT_LEN}-->" value="<!--{$list_data.buy_times_to|escape}-->" size="6" class="box6" style="<!--{$arrErr.buy_times_to|sfGetErrorColor}-->" /> 次
								</td>
							</tr>
							...
							<tr class="fs12n">
								...
								<td bgcolor="#ffffff" width="195">
									...
									<!--{/if}-->
									<input type="text" name="buy_total_from" maxlength="<!--{$smarty.const.INT_LEN}-->" value="<!--{$list_data.buy_total_from|escape}-->" size="6" class="box6" <!--{if $arrErr.buy_total_from || $arrErr.buy_total_to}--><!--{sfSetErrorStyle}--><!--{/if}--> /> 元 ～
									<input type="text" name="buy_total_to" maxlength="<!--{$smarty.const.INT_LEN}-->" value="<!--{$list_data.buy_total_to|escape}-->" size="6" class="box6" <!--{if $arrErr.buy_total_from || $arrErr.buy_total_to}--><!--{sfSetErrorStyle}--><!--{/if}--> /> 元
								</td>
							</tr>
							<!--{*非会員はメルマガ非対応
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">类别</td>
							...
							*}-->
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">邮件地址</td>
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">手机邮件地址</td>
								<td bgcolor="#ffffff" colspan="3">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">送信邮件地址类别</td>
								<td bgcolor="#ffffff" colspan="3">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">出生年月日</td>
								<td bgcolor="#ffffff" colspan="3">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">注册日期</td>
								<td bgcolor="#ffffff" colspan="3">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">促销</td>
								<td bgcolor="#ffffff" colspan="3">
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<td bgcolor="#393a48" class="white10">检索结果一览　<span class="reselt"><!--検索結果数--><!--{$tpl_linemax}-->件</span>&nbsp;が該当しました。</td>
				...
				<td><input type="submit" name="subm" value="设置送信内容" onclick="document.form1['mode'].value='input';"/></td>
			</tr>
		</table>
		</td>
		<td align="right">
				...
				<tr>
					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						<tr bgcolor="#636469" align="center" class="fs12n">
							...
							<td width="80"><span class="white">会员编号</span></td>
							<td width="80"><span class="white">订单编号</span></td>
							<td width="140"><span class="white">姓名</span></td>	
							<td width="190"><span class="white">电子邮件</span></td>	
							<td width="101"><span class="white">希望送信</span></td>
							<td width="100"><span class="white">注册日期</span></td>
							<td width="40"><span class="white">删除</span></td>		
						</tr>
						<!--{section name=i loop=$arrResults}-->
						<tr bgcolor="#FFFFFF" class="fs12n">
							<td align="center"><!--{$smarty.section.i.iteration}--></td>
							<td align="center"><!--{$arrResults[i].customer_id|default:"非会员"}--></td>
							...
							<td align="center">-</td>
							<!--{else}-->
							<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnFormModeSubmit('form1','delete','result_email','<!--{$arrResults[i].email|escape}-->'); return false;">删除</a></td>	
							<!--{/if}-->
						</tr>
						<!--{/section}-->
					</table>
