								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr>
										<td colspan="2" bgcolor="#f2f1ec" width="678" class="fs12n">
											认证密钥可以在<a href="<!--{$smarty.const.OSTORE_URL}-->" target="_blank">EC-CUBE所有者商店</a>取得。
										</td>
									</tr>
									<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
											<td>
												<input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="到确认页面" border="0">
											</td>
											</tr>
										</table>
										</td>
