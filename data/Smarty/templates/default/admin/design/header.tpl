							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->页眉·页脚编辑</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center"><strong>页眉编辑</strong></td>
									</tr>
									<!-- プレビューここから -->
									<!--{ if $header_prev == "on"}-->
									<tr class="fs12n">
										<td bgcolor="#ffffff" align="center">
											...
											<!--{ else }-->
												<span class="red12"><b>预览显示仅限IE。</b></span>
											<!--{ /if }-->
										</td>
									</tr>
									<!--{ /if }-->
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
												<input type='button' value='注册' name='subm' onclick="fnFormModeSubmit('form_header','confirm','','');"  />
												<input type='button' value='预览' name='preview' onclick="lfnSetBrowser('form_header', 'browser_type'); fnFormModeSubmit('form_header','preview','','');"  />
												</td>
											</tr>
										</table>
										</td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center" colspan="3"><strong>页脚编辑</strong></td>
									</tr>
									<!--{ if $footer_prev == "on"}-->
									<tr class="fs12n">
										<td bgcolor="#ffffff" align="center">
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
												<input type='button' value='注册' name='subm' onclick="fnFormModeSubmit('form_footer','confirm','','');"  />
