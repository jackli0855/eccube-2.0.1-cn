						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec">模板文件<br/><span class="red"><span class="fs14n">※文件形式仅限.tar/.tar.gz</span></span></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
											<td><input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_upload_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_upload.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_upload.jpg" width="123" height="24" alt="上传" border="0" name="subm"></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
