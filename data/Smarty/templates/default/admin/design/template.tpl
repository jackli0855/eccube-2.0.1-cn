							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->模板设置</span></td>
									...
									<td>
										<table width="650" bgcolor="#cccccc" border="0" cellspacing="1" cellpadding="5" summary=" ">
											...
											<tr bgcolor="#ffffff" align="center" class="fs12">
												...
												<td width=""><span class="icon_confirm"><a href="" onClick="fnModeSubmit('download','template_code_temp','<!--{$tplcode}-->');return false;">下载</a></span></td>
												<td width=""><span class="icon_delete"><a href="" onClick="fnModeSubmit('delete','template_code_temp','<!--{$tplcode}-->');return false;">删除</a></span></td>
											</tr>
											<!--{/foreach}-->
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													...
													<img onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm">
													</a>
												</td>
											</tr>
										</table>
