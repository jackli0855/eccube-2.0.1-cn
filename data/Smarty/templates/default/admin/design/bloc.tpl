					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->块编辑</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" align="center"><strong>块编辑</strong></td>
							</tr>
							...
							<tr class="fs12n">
								<td bgcolor="#ffffff" align="left">
									...
									ブロック名：<input type="text" name="bloc_name" value="<!--{$arrBlocData.bloc_name|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.bloc_name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" size="60" class="box60" /><span class="red"> （最多<!--{$smarty.const.STEXT_LEN}-->字）</span>
								</td>
							</tr>
							<tr class="fs12n">
								<td bgcolor="#ffffff" align="left">
									<!--{ if $arrErr.filename != "" }--> <div align="center"> <span class="red12"><!--{$arrErr.filename}--></span></div> <!--{/if}-->
									ファイル名：<input type="text" name="filename" value="<!--{$arrBlocData.filename|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.filename != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />.tpl<span class="red"> （最多<!--{$smarty.const.STEXT_LEN}-->字）</span>
								</td>
							</tr>
							...
							<tr class="fs12n">
								<td bgcolor="#ffffff" align="center">
									...
									<div align="right">
									<input type="button" value=<!--{if $text_row > 13}-->"缩小"<!--{else}-->"放大"<!--{/if}--> onClick="ChangeSize(this, bloc_html, 50, 13, html_area_row)">
									</div>
									<br/>
								</td>
							</tr>
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" align="center">
									<input type='button' value='注册' name='subm' onclick="fnFormModeSubmit('form_bloc','confirm','','');"  />
						...
						<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" align="center" colspan=2 ><strong>可编辑块</strong></td>
							</tr>
							...
							<tr class="fs12n" height=20>
								...
								<td  align="center" width=140 bgcolor="<!--{if $item.bloc_id == $bloc_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->">
									<!--{if $item.del_flg == 0}-->
									<input type="button" value="删除" name="del<!--{$item.bloc_id}-->" onclick="fnFormModeSubmit('form_bloc','delete','bloc_id',this.name.substr(3));"  />
							...
							<tr class="fs12n">
								...
								<input type='button' value='制作新的块' name='subm' onclick="location.href='http://<!--{$smarty.server.HTTP_HOST}--><!--{$smarty.server.PHP_SELF|escape}-->'">
								</td>
							</tr>
						</table>
						<!--▲ブロック一覧　ここまで-->
