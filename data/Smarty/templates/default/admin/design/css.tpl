							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->CSS编辑</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center">
											...
											<div align="right">
											<input type="button" value="放大" onClick="ChangeSize(this, css, 50, 30, area_row)">
											</div>
										</td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center">
											<input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" onclick="fnFormModeSubmit('form_css','confirm','','');" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm" >
										</td>
									</tr>
								</table>
								<!--▲CSS編集　ここまで-->
