						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center"><strong>题头编辑</strong></td>
									</tr>
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center">
											...
											<div align="right">
											<input type="button" value=<!--{if $header_row > 13}-->"缩小"<!--{else}-->"放大"<!--{/if}--> onClick="ChangeSize(this, header, 50, 13, header_row)">
											</div><br/>
										</td>
									</tr>
								</table>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center"><strong>内容编辑</strong></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center" colspan="2"><br/>
											...
											<div align="right">
											<input type="button" value="商品设置" onclick="win03('./campaign_create_tag.php?campaign_id=<!--{$arrForm.campaign_id}-->', 'search', '550', '500');">
											<input type="button" value=<!--{if $contents_row > 13}-->"缩小"<!--{else}-->"放大"<!--{/if}--> onClick="ChangeSize(this, contents, 50, 13, contents_row)">
											</div><br/>
										</td>
									</tr>
								</table>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center" colspan="3"><strong>题尾编辑</strong></td>
									</tr>
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" align="center"><br/>
											...
											<div align="right">
											<input type="button" value=<!--{if $footer_row > 13}-->"缩小"<!--{else}-->"放大"<!--{/if}--> onClick="ChangeSize(this, footer, 50, 13, footer_row)">
											</div><br/>
										</td>
									</tr>
								</table>
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													<input type="button" onclick="fnFormModeSubmit('form1', 'return', '', ''); return false;" value="返回注册页面">											
													<input type="button" onclick="fnFormModeSubmit('form1', 'regist', '', ''); return false;" value="保存">
													<input type="button" onclick="fnFormModeSubmit('form1', 'preview', '', ''); return false;" value="预览">
												</td>
											</tr>
										</table>
										</td>
