...
function fnReplaceOption(restSel, addSel) {
	...
	if(fm[restSel].selectedIndex == -1) alert("没有选择任何项目。");
	else {
										...
										<tr class="fs12n">
											...
											<td bgcolor="#ffffff" align="left">
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													<tr class="fs12n">
														<td bgcolor="#f2f1ec" align="center"><strong>输出项目一览</strong></td>
													</tr>
													<tr class="fs12n">
											...
											<td bgcolor="#ffffff" align="cneter">
												<input type="button" value="<< 添加" onClick="fnReplaceOption('choice_list[]', 'output_list[]');"><br/><br/><br/>
												<input type="button" value="删除 >>" onClick="fnReplaceOption('output_list[]', 'choice_list[]');">
											</td>
											<td bgcolor="#ffffff" align="right">
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													<tr class="fs12n">
														<td bgcolor="#f2f1ec" align="center"><strong>可输出项目一览</strong></td>
													</tr>
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
