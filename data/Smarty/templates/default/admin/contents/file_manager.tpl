							...
							<tr valign="top">
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->文件管理</span></td>
									...
									<tr class="fs12n" bgcolor="#ffffff">
										...
										<td><span class="red"><!--{$arrErr.select_file}--></span>
											<div id="file_view">
												<table border="0" cellspacing="0" cellpadding="2" summary=" ">
													...
													<tr class="fs12n" id="parent_dir" onclick="fnSetFormVal('form1', 'select_file', '<!--{$tpl_parent_dir|escape}-->');fnSelectFile('parent_dir', '#808080');" onDblClick="setTreeStatus('tree_status');fnDbClick(arrTree, '<!--{$tpl_parent_dir|escape}-->', true, '<!--{$tpl_now_dir|escape}-->', true)" style="" onMouseOver="fnChangeBgColor('parent_dir', '#808080');" onMouseOut="fnChangeBgColor('parent_dir', '');">
														<td>
															<img src="<!--{$TPL_DIR}-->img/admin/contents/folder_parent.gif" alt="目录">&nbsp;..
														</td>
														<td align="right"></td>
														<td></td>
													</tr>
													...
													<tr class="fs12n" id="<!--{$id}-->" onclick="fnSetFormVal('form1', 'select_file', '<!--{$arrFileList[cnt].file_path|escape}-->');fnSelectFile('<!--{$id}-->', '#808080');" onDblClick="setTreeStatus('tree_status');fnDbClick(arrTree, '<!--{$arrFileList[cnt].file_path|escape}-->', <!--{if $arrFileList[cnt].is_dir|escape}-->true<!--{else}-->false<!--{/if}-->, '<!--{$tpl_now_dir|escape}-->', false)" style="" onMouseOver="fnChangeBgColor('<!--{$id}-->', '#808080');" onMouseOut="fnChangeBgColor('<!--{$id}-->', '');">
														<td>
															...
															<img src="<!--{$TPL_DIR}-->img/admin/contents/folder_close.gif" alt="目录">
															<!--{else}-->
											...
											<table border="0" cellspacing="0" cellpadding="5" summary=" ">
												<tr>
													<td><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('view','',''); return false;" value="显示"></td>
													<td><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('download','',''); return false;" value="下载"></td>
													<td><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('delete','',''); return false;" value="删除"></td>
												</tr>
											</table>
										</td>
									</tr>
								...
								<table width="678" border="1" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td>当前目录&nbsp;：&nbsp;<!--{$tpl_now_dir|sfTrimURL}-->/</td>
									</tr>
								</table>
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
									<td bgcolor="#f2f1ec">文件上传</td>
									<td bgcolor="#ffffff"><span class="red"><!--{$arrErr.upload_file}--></span><input type="file" name="upload_file" size="64" <!--{if $arrErr.upload_file}-->style="background-color:<!--{$smarty.const.ERR_COLOR|escape}-->"<!--{/if}-->><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('upload','',''); return false;" value="上传"></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec">新建目录</td>
