...
function ChangeSize(button, TextArea, Max, Min, row_tmp){
	if(TextArea.rows <= Min){
		TextArea.rows=Max; button.value="缩小"; row_tmp.value=Max;
	}else{
		TextArea.rows =Min; button.value="放大"; row_tmp.value=Min;
	}
}
							...
							<tr>
								...
								<td bgcolor="#cccccc">
									...
									<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" ">
										<tr class="fs12n">
											<td bgcolor="#f2f1ec" align="center" colspan=3 ><strong>SQL一览</strong></td>
										</tr>
										...
										<tr class="fs12n" height=20>
											...
											<td align="center" width=78 bgcolor="<!--{if $item.sql_id == $sql_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->">
												<input type='button' value='CSV输出' name='csv' onclick="fnTargetSelf(); fnFormModeSubmit('form1','csv_output','csv_output_id',<!--{$item.sql_id}-->);"  />
											</td>
											<td align="center" width=78 bgcolor="<!--{if $item.sql_id == $sql_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->">
												<input type='button' value='删除' name='del' onclick="fnTargetSelf(); fnFormModeSubmit('form1','delete','sql_id',<!--{$item.sql_id}-->);"  />
											</td>
										</tr>
										<!--{ /foreach }-->
									</table>
									...
									<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
										...
										<tr>
											...
											<table border="0" cellspacing="0" cellpadding="0" summary=" ">
												<tr>
													<td><input type='button' value='新建SQL' name='subm' onclick="fnTargetSelf(); fnFormModeSubmit('form1','new_page','','');"  /></td>
												</tr>
											</table>
											</td>
											<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
									...
									<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
										...
										<tr>
											<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
											<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->CSV输出设置</span></td>
											<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
										</tr>
										<tr>
											<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
									...
									<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" ">
										<tr class="fs12n">
											<td bgcolor="#f2f1ec" align="center" colspan=2><strong>SQL设置</strong></td>
										</tr>
										<tr class="fs12n">
											<td bgcolor="#f2f1ec" align="center" width="100">名称<span class="red"> *</span></td>
											<td bgcolor="#ffffff" align="left">
												<span class="red12"><!--{$arrErr.sql_name}--></span>
												<input type="text" name="sql_name" value="<!--{$arrSqlData.sql_name|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" size="60" class="box60" /><span class="red"> （最多<!--{$smarty.const.STEXT_LEN}-->字）</span>
											</td>
										</tr>
										<tr class="fs12n">
											<td bgcolor="#f2f1ec" align="center" width="100">SQL语句<br>（请不要写SELECT语句。）<span class="red"> *</span></td>
											<td bgcolor="#ffffff" align="left">
									...
									<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
										...
										<tr>
											...
											<table border="0" cellspacing="0" cellpadding="0" summary=" ">
												<tr>
													<td>
														<input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm" onClick="mode.value='confirm'; fnTargetSelf();">
														<input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_confirm_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_confirm.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_confirm.jpg" width="123" height="24" alt="到确认页面" border="0" name="subm" onClick="doPreview(); return false;">
													</td>
												</tr>
											</table>
											</td>
									...
									<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
											...
											<table width="100%" border="0" cellspacing="1" cellpadding="5" summary=" ">
												<tr class="fs12n">
													<td bgcolor="#f2f1ec" align="center" colspan=2><strong>数据库表一览</strong></td>
												</tr>
												<tr class="fs12n">
											...
											<td width="50%">
												<table width="100%" border="0" cellspacing="1" cellpadding="5" summary=" ">
													<tr class="fs12n">
														<td bgcolor="#f2f1ec" align="center" colspan=2><strong>项目一览</strong></td>
													</tr>
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
