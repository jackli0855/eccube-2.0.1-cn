...
function func_regist(url) {
	res = confirm('可以<!--{if $edit_mode eq "on"}-->编辑<!--{else}-->注册<!--{/if}-->此内容吗？');
	if(res == true) {
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->注册新的</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<thead>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="78">日期<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="" class="fs12n">标题<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="" class="fs12n"><!--{if $arrErr.news_title}--><span class="red"><!--{$arrErr.news_title}--></span><!--{/if}-->
										<textarea name="news_title" cols="60" rows="8" class="area60" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" <!--{if $arrErr.news_title}-->style="background-color:<!--{$smarty.const.ERR_COLOR|escape}-->"<!--{/if}-->><!--{$news_title|escape}--></textarea><br/><span class="red"> （最多<!--{$smarty.const.MTEXT_LEN}-->字）</span>
										</td>
									</tr>
									</thead>
									<tfoot>
									<tr>
										...
										<td bgcolor="#ffffff" width="600" class="fs12n"><span class="red"><!--{$arrErr.news_url}--></span><input type="text" name="news_url" size="60" class="box60"  value="<!--{$news_url|escape}-->" <!--{if $arrErr.news_url}-->style="background-color:<!--{$smarty.const.ERR_COLOR|escape}-->"<!--{/if}--> maxlength="<!--{$smarty.const.URL_LEN}-->"/><span class="red"> （最多<!--{$smarty.const.URL_LEN}-->字）</span>
										</td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="78">链接</td>
										<td bgcolor="#ffffff" width="600"><input type="checkbox" name="link_method" value="2" <!--{if $link_method eq 2}--> checked <!--{/if}--> >以新的窗口打开</td>
									</tr>
									<tr>
										<td bgcolor="#f2f1ec" width="38" class="fs12n">书写正文</td>
										<td bgcolor="#ffffff" width="600" class="fs12n"><!--{if $arrErr.news_comment}--><span class="red"><!--{$arrErr.news_comment}--></span><!--{/if}--><textarea name="news_comment" cols="60" rows="8" wrap="soft" class="area60" maxlength="<!--{$smarty.const.LTEXT_LEN}-->" style="background-color:<!--{if $arrErr.news_comment}--><!--{$smarty.const.ERR_COLOR|escape}--><!--{/if}-->"><!--{$news_comment|escape}--></textarea><br/><span class="red"> （最多3000字）</span>
										</td>
									</tr>
									</tfoot>
								</table>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0" name="subm" onclick="return func_regist();"></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->已登录的新到信息</span></td>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
									</tr>
									<tr>
										<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
								...
								<input type="hidden" name="rank" value="">
									...
									<tr bgcolor="<!--{if $list_data[data].news_id eq $news_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->" class="fs12">
										...
										<td width="" align="center"><a href="#" onclick="return func_edit('<!--{$list_data[data].news_id|escape}-->');">编辑</a></td>
										<td width="" align="center"><a href="#" onclick="return func_del('<!--{$list_data[data].news_id|escape}-->');">删除</a></td>
										<td width="" align="center">
										<!--{if count($list_data) != 1}-->
										到第<input type="text" name="pos-<!--{$list_data[data].news_id}-->" size="3" class="box3" /><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnFormModeSubmit('move', 'moveRankSet','news_id', '<!--{$list_data[data].news_id}-->'); return false;">移动</a><br />
										<!--{/if}-->
