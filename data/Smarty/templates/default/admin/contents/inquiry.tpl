					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル--><!--{if $QUESTION_ID}-->修改<!--{else}-->新建<!--{/if}-->注册</span></td>
						...
						<input type="hidden" name="question_id" value="<!--{$QUESTION_ID}-->">
							...
							<!--{/if}-->
							<tr class="fs12n">
								<td width="140" bgcolor="#f2f1ec">运行·不运行<span class="red">*</span></td>
							...
							<tr class="fs12n">
								<td width="140" bgcolor="#f2f1ec">调查资料标题<span class="red">*</span></td>
								...
								<tr class="fs12n">
								<td width="140" bgcolor="#f2f1ec">调查资料内容<span class="red">*</span></td>
							...
							<tr class="fs12n">
								<td width="140" bgcolor="#f2f1ec">问题<!--{$smarty.section.question.iteration}--><!--{if $smarty.section.question.iteration eq 1}--><span class="red">*</span><!--{/if}--></td>
								<td width="637" bgcolor="#ffffff">
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										<td>
											<input type="submit" name="subm1" value="<!--{if $QUESTION_ID}-->修改<!--{else}-->新建<!--{/if}-->调查资料" />&nbsp;&nbsp;<input type="reset" value="清除内容" />
										</td>
									</tr>
								</table>
								</td>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->已注册的调查资料</span></td>
								<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
							</tr>
							<tr>
								<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
						...
						<form name="form2" method="post" action="<!--{$smaryt.server.PHP_SELF|escape}-->">
							...
							<tr bgcolor="#FFFFFF" class="fs12" <!--{if $list_data[data].question_id eq $smarty.request.question_id}--><!--{sfSetErrorStyle}--><!--{/if}-->>
								<td align="center" class="main"><a href="<!--{$smarty.server.PHP_SELF|escape}-->?question_id=<!--{$list_data[data].question_id}-->">编辑</a></td>
								<td align="center"><!--{$list_data[data].disp_date}--></td>
								<td><!--{$list_data[data].question_name|escape}--></td>
								<td align="center"><a href="<!--{$smarty.const.SITE_URL}-->inquiry/index.php?question_id=<!--{$list_data[data].question_id}-->" target="_blank">参考</a></td>
								<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->?mode=csv&question_id=<!--{$list_data[data].question_id}-->">download</a></td>
								<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->?mode=delete&question_id=<!--{$list_data[data].question_id}-->" onClick="return delete_check()">删除</a></td>
							</tr>
							<!--{/section}-->
						</form>
						</table>
