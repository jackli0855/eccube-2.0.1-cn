							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->促销注册</span></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">	
									...
									<tfoot>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="140">促销时间<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="140" class="fs12n">目录名<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="538">
											...
											<span class="fs10">※<!--{$smarty.const.SITE_URL|sfTrimURL}--><!--{$smarty.const.URL_DIR|sfTrimURL}--><!--{$smarty.const.CAMPAIGN_URL}-->可以用输入的目录名访问了。</span>
										</td>
									</tr>
									<tr>
										<td bgcolor="#f2f1ec" width="140" class="fs12n">申请数控制</td>
										<td bgcolor="#ffffff" width="538" class="fs12n"><span class="red"><!--{$arrErr.limit_count}--></span><input type="text" name="limit_count" size="54" class="box6"  value="<!--{$arrForm.limit_count|escape}-->" <!--{if $arrErr.limit_count}-->style="background-color:<!--{$smarty.const.ERR_COLOR|escape}-->"<!--{/if}--> maxlength="<!--{$smarty.const.STEXT_LEN}-->"/>&nbsp;件切换到结束页面。
										</td>
									</tr>								
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="140">重复申请数控制</td>
										<td bgcolor="#ffffff" width="538"><input type="checkbox" name="orverlapping_flg" id="orverlapping_flg" value="1" <!--{if $arrForm.orverlapping_flg eq 1}--> checked <!--{/if}--> ><label for="orverlapping_flg">控制重复申请</label></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="140">把商品放入购物车。</td>
										<td bgcolor="#ffffff" width="538"><input type="checkbox" onclick="fnIsCartOn()" name="cart_flg" id="cart_flg" value="1" <!--{if $arrForm.cart_flg eq 1}--> checked <!--{/if}--> <!--{if $is_update}-->disabled<!--{/if}-->><label for="cart_flg">把商品放入购物车</label></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="140">免费送货设置</td>
										<td bgcolor="#ffffff" width="538"><input type="checkbox" name="deliv_free_flg" id="deliv_free_flg" value="1" <!--{if $arrForm.deliv_free_flg eq 1}--> checked <!--{/if}--> ><label for="deliv_free_flg">免费送货</label></td>
									</tr>
									</tfoot>
								</table>
								<!--▲登録テーブルここまで-->
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><a href="javascript:fnFormModeSubmit('form1', 'regist', '', '');"><img onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_regist.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_regist.jpg" width="123" height="24" alt="以此内容注册" border="0"></a></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_left_bg.gif"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->促销一览</span></td>										
										<td background="<!--{$TPL_DIR}-->img/contents/contents_title_right_bg.gif"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="18" height="1" alt=""></td>
									</tr>
									<tr>
										<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr bgcolor="#f2f1ec" align="center" class="fs12n">
										<td width="205" rowspan="2">促销名称</td>
										<td width="50" rowspan="2">申请人数</td>
										<td width="160" colspan="2">式样设置</td>
										<td width="50" rowspan="2">编辑</td>
										<td width="50" rowspan="2">删除</td>
									...
									<tr bgcolor="#ffffff" align="center" class="fs12n">
										...
										<td width="80"><a href="<!--{$smarty.const.URL_CAMPAIGN_DESIGN}-->?campaign_id=<!--{$arrCampaign[cnt].campaign_id}-->&status=active">设置</a></td>
										<td width="80"><a href="<!--{$smarty.const.URL_CAMPAIGN_DESIGN}-->?campaign_id=<!--{$arrCampaign[cnt].campaign_id}-->&status=end">设置</a></td>
										<!--{if $arrCampaign[cnt].campaign_id != $arrForm.campaign_id}-->
										<td width="50"><a href="javascript:fnFormModeSubmit('form1', 'update', 'campaign_id', '<!--{$arrCampaign[cnt].campaign_id}-->')">编辑</a></td>
										<!--{else}-->
										<td width="50">编辑</td>
										<!--{/if}-->
										<td width="50"><a href="javascript:fnFormModeSubmit('form1', 'delete', 'campaign_id', '<!--{$arrCampaign[cnt].campaign_id}-->')">删除</a></td>
