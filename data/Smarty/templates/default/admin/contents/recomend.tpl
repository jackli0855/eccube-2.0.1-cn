...
function lfnCheckSetItem( rank ){
	...
	if ( checkRank ){
		if ( rank != checkRank ){
			if( ! window.confirm('可以废弃刚才所选择的第<!--{$checkRank}-->位的信息吗？')){
				flag = false;
			}
		} 
	}
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->推荐商品管理</span></td>
						...
						<input type="hidden" name="rank" value="<!--{$arrItems[$smarty.section.cnt.iteration].rank|escape}-->">
							...
							<tr class="fs12n">
								...
								<td bgcolor="#ffffff" width="40" align="center">
									...
									<a href="#" onClick="return fnInsertValAndSubmit( document.form<!--{$smarty.section.cnt.iteration}-->, 'mode', 'delete', '可以删除吗？' )">删除</a>
									<!--{/if}-->
								</td>
								<td bgcolor="#ffffff" width="40" align="center">
									<a href="#" onclick="lfnCheckSetItem('<!--{$smarty.section.cnt.iteration}-->'); return false;" target="_blank">
									<!--{if $arrItems[$smarty.section.cnt.iteration].product_id}-->商品<br/>修改<!--{else}-->商品<br/>选择<!--{/if}-->
									</a></td>
								<td bgcolor="#ffffff" width="350">
								<table width="350" border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr class="fs12">
										<td width="70">商品名称：<!--{$arrItems[$smarty.section.cnt.iteration].name|escape}--></td>
									</tr>
									<tr><td height="5"></td></tr>
									<tr class="fs12">
										<td colspan="2">推荐说明：</td>
									</tr>
									<tr>
									...
									<!--{if $arrItems[$smarty.section.cnt.iteration].product_id}-->
									<tr><td colspan=2><input type="submit" name="subm" value="注册" onclick="return lfnCheckSubmit(document.form<!--{$smarty.section.cnt.iteration}-->);"/></td></tr>
									<!--{/if}-->
								</table>
								</td>
							</tr>
