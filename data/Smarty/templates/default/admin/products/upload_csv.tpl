					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->商品注册CSV</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" " bgcolor="#cccccc">
							<tr class="fs12n">
								<td bgcolor="#f0f0f0" width="110">CSV文件</td>
								<td bgcolor="#ffffff" width="607">
								<span class="red12"><!--{$arrErr.csv_file}--></span>
								<input type="file" name="csv_file" size="60" class="box60" /><span class="red10"> (第一行标题行)</span></td>
							</tr>
							<tr class="fs12n">
								<td bgcolor="#f0f0f0" width="110">注册信息</td>
								<td bgcolor="#ffffff" width="607">
								<!--{foreach name=title key=key item=item from=$arrTitle}-->
								<!--{$smarty.foreach.title.iteration}-->项目：<!--{$item}--><br>
								<!--{/foreach}-->
								</td>
							</tr>
						</table>
