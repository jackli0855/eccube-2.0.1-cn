						...
						<td bgcolor="#cccccc">
							...
							<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
								...
								<tr>
									...
									<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->分类目录设置(最大<!--{$smarty.const.LEVEL_MAX}-->階層まで)</span></td>
							...
							<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" " bgcolor="#cccccc">
								<tr bgcolor="#ffffff">
									...
									<input type="submit" name="button" value="注册"/><span class="red10"> （最多<!--{$smarty.const.STEXT_LEN}-->字）</span>
									...
									<table border="0" cellspacing="1" cellpadding="5" summary=" " bgcolor="#cccccc">
										...
										<tr bgcolor="<!--{if $arrForm.category_id != $arrList[cnt].category_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->" align="left" class="fs12n">
											...
											<td align="center">
												...
												<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('pre_edit', 'category_id', <!--{$arrList[cnt].category_id}-->); return false;" />编辑</a>
												<!--{else}-->
												正在编辑
												<!--{/if}-->
											</td>
											<td align="center">
												<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('delete', 'category_id', <!--{$arrList[cnt].category_id}-->); return false;" />删除</a>
											</td>
											<td align="center">
											<!--{* 移動 *}-->
											<!--{if $smarty.section.cnt.iteration != 1}-->
											<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('up','category_id', <!--{$arrList[cnt].category_id}-->); return false;">向上</a>
											<!--{/if}-->
											<!--{if $smarty.section.cnt.iteration != $smarty.section.cnt.last}-->
											<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('down','category_id', <!--{$arrList[cnt].category_id}-->); return false;">向下</a>
											<!--{/if}-->
											</td>
										</tr>
										<!--{/section}-->
									...
									<table border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
										<td  class="fs12n">在这一层上没有注册分类目录。</td>
										</tr>
									</table>
									<!--{/if}-->
									</td>
