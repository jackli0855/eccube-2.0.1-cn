...
function lfnDispChange(){
	...
	if(document.getElementById('disp_url1').style.display == 'none'){
		for (i = 1; i <= cnt; i++) {
			...
			document.getElementById(inner_id).innerHTML = '	URL <a href="#" onClick="lfnDispChange();"> <FONT Color="#FFFF99"> >> 显示分类目录</FONT></a>';
		}
	}else{
		for (i = 1; i <= cnt; i++) {
			disp_id = 'disp_url'+i;
			...
			document.getElementById(inner_id).innerHTML = '分类目录 <a href="#" onClick="lfnDispChange();"> <FONT Color="#FFFF99"> >> 显示URL</FONT></a>';
		}
	}
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr class="fs12">
								...
								<td bgcolor="#f2f1ec" width="110">规格名称</td>
							...
							<tr class="fs12">
								<td bgcolor="#f2f1ec" width="110">商品编号</td>
								...
								<td bgcolor="#f2f1ec" width="110">商品名称</td>
							...
							<tr class="fs12">
								...
								<td bgcolor="#f2f1ec" width="110">分类</td>
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">状态</td>
								<td bgcolor="#ffffff" width="499" colspan="3">
	...
	<tr bgcolor="cbcbcb">
		...
		<table border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<input type="button" name="subm" value="删除全部检索结果" onclick="fnModeSubmit('delete_all','','');" />
				<!--{/if}-->
				</td>
				...
				<td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="8" height="1" alt=""></td>
				<td><a href="../contents/csv.php?tpl_subno_csv=product"><span class="fs12n"> >> CSV输出项目设置 </span></a></td>
			</tr>
		</table>
		</td>
		<td align="right">
				...
				<tr>
					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						<tr bgcolor="#636469" align="center" class="fs12n">
							...
							<td width="90" rowspan="2"><span class="white">商品图片</span></td>
							<td width="90"><span class="white">商品编号</span></td>
							<td width="350"><span class="white">商品名称</span></td>
							<td width="60"><span class="white">库存</span></td>
							<td width="50" rowspan="2"><span class="white">编辑</span></td>
							<td width="50" rowspan="2"><span class="white">确认</span></td>
							<!--{if $smarty.const.OPTION_CLASS_REGIST == 1}-->
							<td width="50" rowspan="2"><span class="white">规格</span></td>
							<!--{/if}-->
							<td width="50"><span class="white">删除</span></td>
						</tr>
						<tr bgcolor="#636469" align="center" class="fs12n">
							<td width="90"><span class="white">价格(元)</span></td>
							<td width="430">
								<span class="white"  id="switch">
									分类目录 <a href="#" onClick="lfnDispChange();"> <FONT Color="#FFFF99"> >> 显示URL</FONT></a>
								</span>
							</td>
							<td width="60"><span class="white">分类</span></td>
							<td width="50"><span class="white">复制</span></td>
						</tr>
						...
						<tr bgcolor="<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->" class="fs12n">
							...
							<td align="center" rowspan="2"><span class="icon_edit"><a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnChangeAction('./product.php'); fnModeSubmit('pre_edit', 'product_id', <!--{$arrProducts[cnt].product_id}-->); return false;" >编辑</a></span></td>
							<td align="center" rowspan="2"><span class="icon_confirm"><a href="<!--{$smarty.const.SITE_URL|sfTrimURL}-->/products/detail.php?product_id=<!--{$arrProducts[cnt].product_id}-->&admin=on" target="_blank">确认</a></td>
							<!--{if $smarty.const.OPTION_CLASS_REGIST == 1}-->
							<td align="center" rowspan="2"><span class="icon_class"><a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnChangeAction('./product_class.php'); fnModeSubmit('pre_edit', 'product_id', <!--{$arrProducts[cnt].product_id}-->); return false;" >规格</a></td>
							<!--{/if}-->
							<td align="center"><span class="icon_delete"><a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnSetFormValue('category_id', '<!--{$arrProducts[cnt].category_id}-->'); fnModeSubmit('delete', 'product_id', <!--{$arrProducts[cnt].product_id}-->); return false;">删除</a></span></td>
						</tr>
						<tr bgcolor="<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->" class="fs12n">
							<td align="right">
							<!--{* 価格 *}-->
							...
							<td align="center"><span class="icon_copy"><a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnChangeAction('./product.php'); fnModeSubmit('copy', 'product_id', <!--{$arrProducts[cnt].product_id}-->); return false;" >复制</a></span></td>
						</tr>
						<!--▲商品<!--{$smarty.section.cnt.iteration}-->-->
						<!--{/section}-->
