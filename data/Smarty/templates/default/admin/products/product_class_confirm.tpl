							...
							<tr>
								...
								<!--{if $tpl_check > 0}-->
									...
									<tr bgcolor="#f2f1ec" align="center" class="fs12n">
										<td width="150">规格1(<!--{$arrClass[$class_id1]|default:"未选择"}-->)</td>
										<td width="150">规格2(<!--{$arrClass[$class_id2]|default:"未选择"}-->)</td>
										<td width="100">商品编号</td>
										<td width="80">库存(个)</td>
										<td width="120"><!--{$smarty.const.NORMAL_PRICE_TITLE}-->(元)</td>
										<td width="100"><!--{$smarty.const.SALE_PRICE_TITLE}-->(元)</td>
									</tr>
									...
									<!--{/section}-->
								<!--{else}-->
									<tr bgcolor="#ffffff" class="fs12" align="center"><td>未选择规格。</td></tr>
								<!--{/if}-->
								</table>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><a href="#" onmouseover="chgImg('<!--{$TPL_DIR}-->img/install/back_on.jpg','return')" onmouseout="chgImg('<!--{$TPL_DIR}-->img/install/back.jpg','return')" onclick="fnModeSubmit('confirm_return','',''); return false" /><img  width="105" src="<!--{$TPL_DIR}-->img/install/back.jpg"  height="24" alt="回到前面" border="0" name="return"></a>
												<!--{if $tpl_check > 0}-->
