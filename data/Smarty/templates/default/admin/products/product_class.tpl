						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">规格1<span class="red">*</span></td>
									...
									<tr>
									<td bgcolor="#f2f1ec" width="160" class="fs12n">规格2</td>
									<td bgcolor="#ffffff" width="557" class="fs12n">
									...
									<tr>
										<td align="center" bgcolor="#f2f1ec" colspan=2>
											<input type="button" value="返回检索结果" onclick="fnChangeAction('<!--{$smarty.const.URL_SEARCH_TOP}-->'); fnModeSubmit('search','',''); return false;" >
											<input type="button" name="btn" value="显示" onclick="fnModeSubmit('disp','','')">
											<!--{if count($arrClassCat) > 0}-->
											<input type="button" name="btn" value="删除" onclick="fnModeSubmit('delete','','');">
											<!--{/if}-->
										</td>
									</tr>
								</table>
								...
								<!--{if count($arrClassCat) > 0}-->
									...
									<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr bgcolor="#f2f1ec">
											<td class="fs12n" align="left">
												<a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnAllCheck(); return false;">全部选择</a>　
												<a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnAllUnCheck(); return false;">全部取消</a>　
												<a href="<!--{$smarty.const.URL_DIR}-->" onclick="fnCopyValue('<!--{$cnt}-->', '<!--{$smarty.const.DISABLED_RGB}-->'); return false;">拷贝第一行的数据</a></td>
										</tr>
									</table>
									...
									<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
										...
										<tr bgcolor="#f2f1ec" align="center" class="fs12n">
											<td width="30">注册</td>
											<td width="100">规格1(<!--{$arrClass[$class_id1]|default:"未选择"}-->)</td>
											<td width="100">规格2(<!--{$arrClass[$class_id2]|default:"未选择"}-->)</td>
											<td width="80">商品编号</td>
											<td width="160">库存(个)<span class="red">*</span></td>
										...
										<tr  bgcolor="#ffffff" class="fs10n">
											...
											<input type="checkbox" name="<!--{$key}-->" value="1" <!--{if $arrForm[$key] == "1"}-->checked<!--{/if}--> onClick="fnCheckStockNoLimit('<!--{$smarty.section.cnt.iteration}-->','<!--{$smarty.const.DISABLED_RGB}-->');"/>无限制</td>
											</td>
