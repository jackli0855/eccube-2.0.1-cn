				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">投稿者姓名</td>
								...
								<td bgcolor="#f2f1ec" width="110">主页地址</td>
							...
							<tr class="fs12n">
								...
								<td bgcolor="#f2f1ec" width="110">推荐等级</td>
					...
					<tr>
						...
						<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr bgcolor="#636469" align="center" class="fs12">
								...
								<td width="100"><span class="white">投稿者姓名</span></td>
								<td width="252"><span class="white">商品名称</span></td>
								<td width="100"><span class="white">推荐等级</span></td>
								<td width="80"><span class="white">显示·不显示</span></td>
							...
							<tr bgcolor="#ffffff" class="fs12">
								...
								<td align="center"><!--{if $arrReview[cnt].status eq 1}-->显示<!--{elseif $arrReview[cnt].status eq 2}-->不显示<!--{/if}--></td>
								<td align="center"><a href="#" onclick="fnChangeAction('./review_edit.php'); fnModeSubmit('','review_id','<!--{$arrReview[cnt].review_id}-->');">编辑</a></td>
								<td align="center"><a href="#" onclick="fnModeSubmit('delete','review_id','<!--{$arrReview[cnt].review_id}-->'); return false;">删除</a></td>
							</tr>
							<!--{/section}-->
						</table>
						<!--検索結果表示テーブル-->
