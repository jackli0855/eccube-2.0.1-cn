						...
						<td bgcolor="#cccccc">
							...
							<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
								...
								<tr>
									...
									<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->商品排序</span></td>
							...
							<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" " bgcolor="#cccccc">
								...
								<tr bgcolor="#ffffff">
									...
									<table width="428" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr><td class="fs12n">检索到<!--{$tpl_linemax}-->条。	</td></tr>
										<tr class="fs12">
											<td align="center">
											<!--▼ページナビ-->
											<!--{$tpl_strnavi}-->
									...
									<table border="0" cellspacing="1" cellpadding="5" summary=" " bgcolor="#cccccc">
										...
										<tr bgcolor="#ffffff" align="left" class="fs12n">
											...
											到第<input type="text" name="pos-<!--{$arrProductsList[cnt].product_id}-->" size="3" class="box3" /><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('move','product_id', '<!--{$arrProductsList[cnt].product_id}-->'); return false;">移动</a><br />
											<!--{/if}-->
											<!--{if !($smarty.section.cnt.first && $tpl_disppage eq 1) }-->
											<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('up','product_id', '<!--{$arrProductsList[cnt].product_id}-->'); return false;">向上</a>
											<!--{/if}-->
											<!--{if !($smarty.section.cnt.last && $tpl_disppage eq $tpl_pagemax) }-->
											<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('down','product_id', '<!--{$arrProductsList[cnt].product_id}-->'); return false;">向下</a>
											<!--{/if}-->
											</td>
										</tr>
										<!--{/section}-->
									...
									<!--{else}-->
									<td width="428" valign="top" class="fs12n">请选择分类目录。</td>
									<!--{/if}-->
									<!--▲画面右-->
								</tr>
							</table>
