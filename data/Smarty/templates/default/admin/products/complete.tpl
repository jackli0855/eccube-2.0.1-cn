				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" " height="350">
							<tr class="fs12" >
								<td height="150" bgcolor="#ffffff" class="fs18n" align="center">注册结束了。<br /> <br /> <br />
								<a href="./product.php">→继续进行注册。</a><br /> <br /> <br />
								<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('pre_edit', 'product_id', '<!--{$tpl_product_id}-->'); return false;">→注册此商品的规格。</a></td>
							</tr>
						</table>
						<!--完了メッセージテーブルここまで-->
						</td>
