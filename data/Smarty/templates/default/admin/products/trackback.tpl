				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">Blog名称</td>
								...
								<td bgcolor="#f2f1ec" width="110">Blog文章<br />タイトル</td>
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">投稿日期</td>
				...
				<tr>
					...
					<table border="0" cellspacing="0" cellpadding="0" summary=" ">
						...
						<tr>
							...
							<td bgcolor="#393a48" class="white10">检索结果一览　<span class="reselt"><!--検索結果数-->检索到<!--{$tpl_linemax}-->件</span>&nbsp;。</td>
					...
					<tr>
						...
						<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr bgcolor="#636469" align="center" class="fs12">
								<td width="130"><span class="white">投稿日期</span></td>
								<td width="162"><span class="white">商品名称</span></td>
								<td width="150"><span class="white">Blog名</span></td>
								<td width="140"><span class="white">Blog文章标题</span></td>
								<td width="80"><span class="white">状态</span></td>
							...
							<tr bgcolor="#ffffff" class="fs12">
								...
								<td align="center"><!--{if $arrTrackback[cnt].status eq 1}-->显示<!--{elseif $arrTrackback[cnt].status eq 2}-->不显示<!--{elseif $arrTrackback[cnt].status eq 3}-->垃圾信息<!--{/if}--></td>
								<td align="center"><a href="#" onclick="fnChangeAction('./trackback_edit.php'); fnModeSubmit('','trackback_id','<!--{$arrTrackback[cnt].trackback_id}-->');">编辑</a></td>
								<td align="center"><a href="#" onclick="fnModeSubmit('delete','trackback_id','<!--{$arrTrackback[cnt].trackback_id}-->'); return false;">删除</a></td>
							</tr>
							<!--{/section}-->
						</table>
						<!--検索結果表示テーブル-->
