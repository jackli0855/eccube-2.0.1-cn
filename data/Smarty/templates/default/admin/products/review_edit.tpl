						...
						<td bgcolor="#cccccc">
							...
							<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
								...
								<tr>
									...
									<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->分类目录设置</span></td>
							...
							<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" " bgcolor="#cccccc">
								...
								<tr class="fs12n">
									<td bgcolor="#f2f1ec">预览显示</td>
									<td bgcolor="#ffffff"><!--{if $arrErr.status}--><span class="red12"><!--{$arrErr.status}--></span><br /><!--{/if}-->
									<input type="radio" name="status" value="2" <!--{if $arrReview.status eq 2}-->checked<!--{/if}-->>不显示<!--{if $arrReview.status eq 2 && !$tpl_status_change}--><!--{else}--><input type="radio" name="status" value="1" <!--{if $arrReview.status eq 1}-->checked<!--{/if}-->>显示<!--{/if}--></td>
								</tr>
								<tr class="fs12n">
