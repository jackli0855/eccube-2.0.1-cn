								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										...
										<td bgcolor="#ffffff" width="527">
											...
											<input type="radio" name="status"value=1 id="no_mem" <!--{if $list_data.status == 1}--> checked="checked" <!--{/if}--> <!--{if $list_data.status == 2}-->disabled<!--{/if}-->><label for="no_mem">临时会员</label>
											<input type="radio" name="status"value=2 id="mem"<!--{if $list_data.status == 2}--> checked="checked" <!--{/if}-->><label for="mem">正式会员</label>
										</td>
									</tr>
									<tr class="fs12n">
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="190">拼音<span class="red"> *</span></td>
									...
									<tr class="fs12n">
										...
										<input type="button" name="address_input" value="住址输入" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01');" /></td>
									</tr>
									<tr>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="190" class="fs12n">电子邮件<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="190" class="fs12n">电子邮件(手机)</td>
									...
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="190">传真</td>
									...
									<tr class="fs12n">
										...
										<td class="red10" bgcolor="#ffffff" width="527"><span class="red12"><!--{$arrErr.password}--></span><input type="password" name="password" value="<!--{$list_data.password|escape}-->" size="30" class="box30" <!--{if $arrErr.password != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />　半角英文数字4～10字（不允许符号）</td>
									</tr>
									<tr>
										<td bgcolor="#f2f1ec" width="190" class="fs12">忘记密码时的提示<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="527">
										<table width="527" border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr class="fs12n">
												<td><span class="red12"><!--{$arrErr.reminder}--><!--{$arrErr.reminder_answer}--></span>问题： <select name="reminder" <!--{if $arrErr.reminder != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> >
												<option value="" selected="selected">请选择</option>
											...
											<tr><td height="5"></td></tr>
											<tr class="fs12n">
												<td>回答： <input type="text" name="reminder_answer" value="<!--{$list_data.reminder_answer|escape}-->" size="30" class="box30" <!--{if $arrErr.reminder_answer != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> /></td>
											</tr>
										</table>
										</td>
									</tr>
									<tr class="fs12n">
										...
										<td bgcolor="#ffffff" width="527"><span class="red12"><!--{$arrErr.mailmaga_flg}--></span>
											...
											<input type="radio" name="mailmaga_flg" value="2" <!--{if $arrErr.mailmaga_flg != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> <!--{if $list_data.mailmaga_flg eq 2 or $list_data.mailmaga_flg eq 5}-->checked<!--{/if}--> />文本　
											<input type="radio" name="mailmaga_flg" value="3" <!--{if $arrErr.mailmaga_flg != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> <!--{if $list_data.mailmaga_flg eq "" or $list_data.mailmaga_flg eq 3 or $list_data.mailmaga_flg eq 6}-->checked<!--{/if}--> />不希望</td>
									</tr>
									<tr>
										<td bgcolor="#f2f1ec" width="960" class="fs12n">SHOP用笔记</td>
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
												<!--▼検索結果へ戻る-->
													<a href="#" onmouseover="chgImg('<!--{$TPL_DIR}-->img/contents/btn_search_back_on.jpg','back');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/contents/btn_search_back.jpg','back');" onclick="return fnReturn();"><img src="<!--{$TPL_DIR}-->img/contents/btn_search_back.jpg" width="123" height="24" alt="返回检索页面" border="0" name="back"></a>
												<!--▲検索結果へ戻る-->
													<input type="image" onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_confirm_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_confirm.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_confirm.jpg" width="123" height="24" alt="到确认页面" border="0" name="subm" >
												</td>
											</tr>
										</table>
										</td>
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<td bgcolor="#393a48" class="white10">购物履历一览　<span class="reselt"><!--購入履歴一覧--><!--{$tpl_linemax}-->件</span>&nbsp;が該当しました。</td>
				...
				<tr>
					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						<tr bgcolor="#636469" align="center" class="fs10n">
							<td width="160"><span class="white">日期</span></td>
							<td width="140"><span class="white">订单编号</span></td>
							<td width="140"><span class="white">购物金额</span></td>
							<td width="160"><span class="white">发货日期</span></td>
							<td width="140"><span class="white">支付方法</span></td>
						</tr>
						...
						<td width=""><!--{$arrPurchaseHistory[cnt].payment_total|number_format}-->元</td>
						<td width=""><!--{if $arrPurchaseHistory[cnt].status eq 5}--><!--{$arrPurchaseHistory[cnt].commit_date|sfDispDBDate}--><!--{else}-->未发货<!--{ /if }--></td>
					...
					<!--{else}-->
					<td align="center" class="fs12">没有购物履历。</td>
					<!--{/if}-->
				</tr>
			</table>
		</td>
