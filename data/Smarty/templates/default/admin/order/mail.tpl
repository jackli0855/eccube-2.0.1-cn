					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->邮件发送</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="5" summary=" ">
							<tr align="center">
								<td bgcolor="#f2f1ec" width="140" class="fs12n">处理日期</td>
								<td bgcolor="#f2f1ec" width="300" class="fs12n">通知邮件</td>
								<td bgcolor="#f2f1ec" width="300" class="fs12n">标题</td>
							</tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr>
								<td bgcolor="#f2f1ec" width="160" class="fs12">邮件开头</td>
							...
							<tr>
								<td bgcolor="#f2f1ec" width="160" class="fs12">邮件结尾</td>
								<td bgcolor="#ffffff" width="557" class="fs10">
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										<td>
											<input type="button" name="back" value="返回检索结果" onclick="fnChangeAction('<!--{$smarty.const.URL_SEARCH_ORDER}-->'); fnModeSubmit('search','',''); return false;" />
											<input type="submit" name="subm" value="确认送信内容"/>
										</td>
									</tr>
								</table>
								</td>
