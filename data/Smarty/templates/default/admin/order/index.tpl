				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" width="110">支付方法</td>
								<td bgcolor="#ffffff" width="499" colspan="3">
	...
	<tr bgcolor="cbcbcb">
		...
		<table border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="8" height="1" alt=""></td>
				<td><a href="../contents/csv.php?tpl_subno_csv=order"><span class="fs12n"> >> CSV输出项目设置 </span></a></td>
			</tr>
		</table>
		</td>
		<td align="right">
				...
				<tr>
					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						...
						<tr bgcolor="#636469" align="center" class="fs12n">
							<td width="130"><span class="white">订购日期</span></td>
							<td width="70"><span class="white">订单编号</span></td>
							<td width="120"><span class="white">顾客名</span></td>
							<td width="75"><span class="white">支付方法</span></td>
							<td width="80"><span class="white">购物金额(元)</span></td>
							<td width="130"><span class="white">所有商品送货日期</span></td>
							<td width="75"><span class="white">处理状况</span></td>
							<td width="50"><span class="white">编辑</span></td>
							<td width="50"><span class="white">邮件</span></td>
						...
						<tr bgcolor="<!--{$arrORDERSTATUS_COLOR[$status]}-->" class="fs12n">
							...
							<td align="center"><!--{$arrResults[cnt].commit_date|sfDispDBDate|default:"未送货"}--></td>
							<td align="center"><!--{$arrORDERSTATUS[$status]}--></td>
							<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnChangeAction('<!--{$smarty.const.URL_ORDER_EDIT}-->'); fnModeSubmit('pre_edit', 'order_id', '<!--{$arrResults[cnt].order_id}-->'); return false;"><span class="icon_edit">编辑</span></a></td>
							...
							<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('delete', 'order_id', <!--{$arrResults[cnt].order_id}-->); return false;"><span class="icon_delete">删除</span></a></td>
						</tr>
						<!--{/section}-->
