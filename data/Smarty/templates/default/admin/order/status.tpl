					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->状态管理</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr bgcolor="#ffffff">
								...
								<!--{if $tpl_linemax > 0 }-->
									<table border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
											<td>
												...
												<option value="" selected="selected" style="<!--{$Errormes|sfGetErrorColor}-->" >请选择</option> 
											...
											<td><input type="button" name="regist" value="提交" onclick="fnSelectCheckSubmit();"></td>
										</tr>
									</table>

									<table width="650" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr class="fs12"><td align="left">检索到<!--{$tpl_linemax}-->条。	</td></tr>
										<tr class="fs12">
											<td align="center">
											<!--▼ページナビ-->
											<!--{$tpl_strnavi}-->
									...
									<table width="650" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
										<td align="right"><input type="button" name="btn01" value="全部选择" onclick="fnBoxChecked(true);"> <input type="button" name="btn01" value="全部取消" onclick="fnBoxChecked(false);"></td>
										</tr>
									...
									<td align="center"><!--{if $arrStatus[cnt].status eq 5}--><!--{$arrStatus[cnt].commit_date|sfDispDBDate:false}--><!--{else}-->未送货<!--{/if}--></td>
								...
								<!--{elseif $arrStatus != "" & $tpl_linemax == 0}-->
									<table width="650" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr class="fs12"><td align="center">没有符合条件的数据。</td></tr>
									</table>
								<!--{/if}-->
