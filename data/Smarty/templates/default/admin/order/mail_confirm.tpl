				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr align="center">
								<td bgcolor="#f2f1ec" width="50" class="fs12n">标题</td>
								<td bgcolor="#ffffff" width="500" class="fs12n"><!--{$tpl_subject|escape}--></td>
							</tr>
							<tr>
								<td align="center" bgcolor="#f2f1ec" width="50" class="fs12n">正文</td>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										<td>
											<input type="button" name="return" value="返回上一页面" onclick="fnModeSubmit('return', '', '');"/>
											<input type="submit" name="subm" value="邮件发送" onclick="return confirm('将以此内容发送邮件，可以吗');"/>
										</td>
									</tr>
								</table>
								</td>
